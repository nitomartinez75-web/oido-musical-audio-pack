# Oído Musical · Pack de audio premium v0.8.1
...
## Novedades v0.8.1
- CORREGIDO: las piezas de época sonaban mudas (error de normalización). Ahora suenan
  con volumen correcto y sin intros silenciosas largas. Se sirven desde Statically/raw
  para evitar el límite de tamaño de jsDelivr.
